    ...
    //On prépare nos données
        if(isset($_POST)){
                ...
                && isset($_POST['prenom']) && !empty($_POST['prenom']))
            {
                ...
                $sql = 'INSERT INTO inscription(nom,prenom,email,mot_de_passe,numero,ville,pays) 
                VALUES(upper("'.$nom.'"), "'.$prenom.'", "'.$email.'", "'.$mot_de_passe.'","'.$numero.'", "'.$ville.'","'.$pays.'")';
...
<div class="container" id="container1">
        <div class="row">
            ...
            <div class="col-sm-4 bg-">
                ...
                <form method="post" action="inscription.php" id="inscri">
                    ...
                    <div>
                      ...
                      <input type="tel" class="form-control" name="numero" id="numero" placeholder="numero" >
                    </div>
                    ...
                    <div>
                     <label for="pays-select"></label>
                            ...
                            <select name="pays" id="pays-select" class="form-control">
                                
                                <option value="portugal">france</option>
                    ...
                    <div class="row" id="myrowsing">
                        ...
                        <div class="col-md-4" id="leftt2"></div>
                        <div class="col-md-4" id="leftt3">
            ...
            <div class="col-sm-4 bg-"><img class="logo3" src=""></div>
