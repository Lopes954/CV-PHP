                    ...
                    <div class="row" id="myrowdash10">
                        <div class="col-md-4" id="dash12">
                            <button class="btn btn-success">
                                <a class="ajout" href="addformation.php" id="dash12">Ajouter</a>
                            </button>
                        </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="ikp1">
                                <a class="#" href="updateformation.php?id=<?= $formation['id']?>">
                                    <i class="fas fa-sync-alt ikp21"></i>
                                </a>
                            </td>
                            <td class="ikp1">
                                <a class="#" href="deleteformation.php?id=<?= $formation['id']?>">
