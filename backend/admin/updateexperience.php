    ...
    if(isset($_POST))
    {
        if(isset($_POST['id']) && !empty($_POST['id'])
            ...
            
            {
                ...
                $sql = "UPDATE `experience` SET `debut`=:debut, `fin`=:fin, `lieu`=:lieu, `poste`=:poste, `descriptif`=:descriptif WHERE `id`=:id;";
                    ...
                    <div class="row">
                        <div class="col-md-6 " id="dash11">
                            <button type="button" class="btn btn-success">
                                <a href="addexperience.php" id="dash12">Ajouter</a>
                            </button>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="fin" id="fin"  value="<?= $result['fin'] ?>"></td>
                            <td><input type="text" name="lieu" id="lieu"    value="<?= $result['lieu'] ?>"></td>
                            <td><input type="text" name="poste" id="poste"   value="<?= $result['poste'] ?>"></td>
                            <td><input type="text" name="descriptif" id="descriptif"  value="<?= $result['descriptif'] ?>"></td>
